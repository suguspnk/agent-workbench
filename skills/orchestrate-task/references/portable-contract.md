...
```json
{
  ...
  "ownership_probe": {
    ...
    "max_waits": 0,
    "outcomes": {
      "inconclusive-delegate": "request-exact-repository-before-planner-for-registered-artifact-work-if-direct-identity-missing-otherwise-normal-full-flow",
